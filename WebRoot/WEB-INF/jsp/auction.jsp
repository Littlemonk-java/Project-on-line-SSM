								...
								<div class="widget-body  am-fr">
													...
													<tr class="gradeX">
														...
														<td>
															<div class="tpl-table-black-operation asd"
																aid="${list.id }" time="${list.auctionend}"
																stste="${list.state }" porname="${list.name }">
									...
									<div class="am-u-lg-12 am-cf">
										...
										<div class="am-fr">
											...
											<input type="hidden" id="idhidden" value="" /> <input
												type="hidden" id="porname" value="" />
										</div>
									</div>
								</div>
							</div>
...
<script type="text/javascript">
	...
	function tongji() {
		if ($("#idhidden").val() == "") {
			...
			window.location = "${pageContext.request.contextPath }/sys/porject?id="
					+ num1
					+ "&name="
					+ num
					+ "&porid="
